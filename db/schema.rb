...
ActiveRecord::Schema[7.0].define(version: 2023_02_08_194740) do
  ...
  create_table "contents", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["team_id"], name: "index_contents_on_team_id"
  end
  ...
  add_foreign_key "contents", "teams"
  ...
  add_foreign_key "strengths", "features"
  add_foreign_key "users", "oauth_applications", column: "platform_agent_of_id"
  add_foreign_key "weaknesses", "features"
